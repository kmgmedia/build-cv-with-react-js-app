...
import { Macpckmgfoliobig, Backgroundpattern,kmgbigg, kmgphones, kmgphones2 } from '../../assets';
    ...
    <div class="col-sm-12 col-md-12 col-lg-1"></div>
            <div class="col-sm-12 col-md-12 col-lg-10">
                ...
                <div className="row overall-container">
                    ...
                    <p>
                    It reflects my
                    dedication to creating a tool that not only showcases my work effectively but also
                    offers an excellent user experience.
                    </p>
                    <p>
                    The primary objective behind Kmgfolio was to
                    develop a platform that allows for the rapid creation of professional portfolios.
                    Recognizing the need for a portfolio solution that is both aesthetically pleasing
                    and functionally robust, I embarked on this project to address these requirements efficiently.
                    </p>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-1"></div>
                    ...
                    <div className='description'>
                            ...
                            <p>UX Research, Information Architecture, Wire-framing,
                            User Interface Design, Prototyping.</p>
                            <h4>Scope</h4>
                            <div>
                                2 months, November - April 2023
                            </div>
                            <div>
                                <h4>Tools</h4>
                                ...
                                {/* <p>
                                UX Research, Figma, UI Design, GIT, Prototyping, ReactJS, JavaScript, SASS,
                                Mongo DB, Node JS
                                </p> */}
                            </div>
                        </div>
